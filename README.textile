...
# Copy from modules/languages/language/english/multi_lang.php and paste it.
# This file is for general language in the webshop. Change the content of the file.
